# 強迫症系統（Compulsion）⚠️ 已廢棄

> **⚠️ 2026-04-22：本設計已廢棄**，被 [fervor.md](fervor.md) 取代。
> 原因：舊設計懲罰專精玩家（連 5 天訓練 = 負面特性 + 20 天解除），
> 跟「鼓勵專精」的遊戲哲學衝突。玩家必須訓練才能成長，卻因此中詛咒。
> 新設計「狂熱」改為正面獎勵 + 屬性突破儀式，見 [fervor.md](fervor.md)。
> 本檔保留作為設計演化歷史紀錄，不再實作。
