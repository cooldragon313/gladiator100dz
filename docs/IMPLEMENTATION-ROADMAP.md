...
| **P1B** | ✅ 完成 | 領主提圖斯主線 | 8/8 |
| **P1C** | ✅ 完成 | 凱德主線（Day 25/49/70/80/90 + Day 100 已實作） | 6/6 |
| **P2** | 🟢 進行中（MVP）| 蓋烏斯 + 維努斯場（NPC 線）| 3/8 |
| **P-Errand** | ✅ 完成 | 跑腿外出系統（4 源頭 + 撞小孩 + 護衛分支 + boss + 鳶尾紋飾 + 3 NPC 認出 + 防逃）| 8/8 |
| **P3** | 🟢 進行中（MVP）| 訓練所內部事件 | 3/7 |
