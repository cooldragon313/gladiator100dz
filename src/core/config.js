...
const Config = (() => {
  ...
  const TRAIT_DEFS = {
    ...
    // 🆕 2026-05-13 債務纏身（救索爾路線、debt_to_master ≥ 500 自動掛、清零自動移除）
    //   壓力激發潛能型：訓練 +10% / 戰鬥首回合 +10% / 跑腿 +20% / 但 mood 下限 -10 / 心情恢復 -20%
    //   設計：docs/quests/sol-arc.md
    debt_ridden: {
      id: 'debt_ridden', name: '債務纏身', category: 'mixed',
      desc: '欠的錢比你的身子重。但你也因此學會了什麼叫拼。訓練 +10%、戰鬥首回合 +10%、跑腿 +20%、mood 下限 -10、心情恢復 -20%。',
    },
    // 升級版：debt ≥ 1000 自動掛（取代 debt_ridden）
    debt_crushed: {
      id: 'debt_crushed', name: '債務纏身（絕望）', category: 'mixed',
      desc: '債務已經吞了你的影子。但你也已經沒退路。訓練 +20%、戰鬥首回合 +20%、跑腿 +30%、mood 下限 -20、心情恢復 -40%。',
    },
