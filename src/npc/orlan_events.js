    ...
    const choices = [
      {
        ...
        // 🆕 2026-04-24：HP -40 是全劇最重的鞭刑，演出要對等（鐵則 11）
        resultEffect: 'shake-and-flash',
        resultDialogue: [
          { speaker: '主角', text: '——那個藥，是我要他拿的。' },
          { text: '（全場安靜。）' },
          { text: '（侍從把你按到木樁上。）' },
          ...
          { text: '（咻——！）', effect: 'shake-big' },
          { speaker: '主角', text: '⋯⋯！！' },
          { text: '（你的眼前一陣白。背已經沒感覺了。）' },
          { text: '（不知道過了多久，鞭子停了。）' },
          { text: '（奧蘭撲到你身邊。他在哭——但他在你耳邊說了一句話。）' },
          { text: '（你沒聽清。你只記得他的眼淚滴在你的臉上。）' },
        ],
        resultLog: '你替奧蘭扛下了那頓鞭。他這輩子記著。',
        logColor:  '#d9a84f',
      },
      {
        id:    'stay_silent',
