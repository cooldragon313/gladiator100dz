  ...
  const NPC_DEFS = {
    ...
    orlan: {
      ...
      storyReveals: [
        ...
        // 2. 沙地畫磨坊（aff ≥ 35）
        // 🆕 2026-04-19：取代原本的磨劍事件（無武器時會有矛盾）。
        //   奧蘭用樹枝在訓練場角落畫磨坊，但畫不完整 — 離家 10+ 年，記憶失真。
        //   為 Phase 2 的重複事件鋪路：每次畫得更接近完整，直到 Day 70+ 才畫出完整磨坊。
        {
          id:        'orlan_draws_mill',
          type:      'event',
          affection: 35,
          ...
          onceOnly:  true,
          logColor:  '#c8a878',
          text:      '訓練場角落，奧蘭蹲著用樹枝在沙地上畫什麼。你走近看——是一座磨坊。歪歪斜斜的，他畫了幾遍又擦掉。',
          dialogueLines: [
            { text: '訓練結束，你走過訓練場角落。' },
            { text: '奧蘭蹲在那裡，用一根樹枝在沙地上畫什麼。' },
            { text: '你走近看——是一座磨坊。' },
            { text: '歪歪斜斜的。他畫了幾筆，又皺眉擦掉。' },
            { speaker: '奧蘭', text: '⋯⋯記不清楚了。' },
            { text: '他重新畫。' },
            { text: '畫了幾遍。擦了幾遍。' },
            { text: '最後一次他沒擦，默默站起來。' },
            { text: '走之前拍了拍沙地上的痕跡，像是跟它告別。' },
            { speaker: '奧蘭', text: '⋯⋯明天再試。' },
            { text: '（你看著他的背影。他已經離家 10 年了。）' },
          ],
        },
        ...
        //   + effects mood-8（可被 emotion modulator 調整：冷酷 ×0.5 / 多愁善感 ×1.5）
        {
          ...
          dialogueLines: (player) => {
            const baseOpen = [
              ...
              { text: '他笑了。但眼眶紅了一圈。' },
              // 🆕 2026-04-19：暗示 Livia 管道（主人家書不合阿圖斯作風）
              { text: '（主人傳信？⋯⋯這不像是大人的做法。）' },
            ];
            // 依 origin 玩家內心獨白
            const innerMap = {
        ...
        // 8. 第二百次跌倒（aff ≥ 40，Day 70+）— 2026-04-20 重寫
        //   加轉折 + 主題句 + 反問玩家（「你為誰活」）
        {
          id:        'orlan_200_falls',
          type:      'event',
          ...
          logColor:  '#e8d070',
          text:      '你看著奧蘭第兩百次跌倒又站起。他不是不會倒。他是不能倒。妹妹等他活著。而你 — 你為誰活？',
          dialogueLines: [
            { text: '（訓練場。又一場切磋。）' },
            { text: '（奧蘭倒下了。）' },
            { text: '' },
            { text: '（他沒哭，沒咒罵。）' },
            { text: '（他用手背擦了嘴角 — 擦出一道血痕。）' },
            { text: '（然後慢慢爬起來。）' },
            { text: '' },
            { text: '（你突然發現自己在數。）' },
            { text: '（第一百次的時候，你驚訝。）' },
            { text: '（第一百五十次的時候，你覺得他會停。）' },
            { text: '' },
            { text: '（這次 — 第兩百次。）' },
            { text: '（你以為他會跪下來。）' },
            { text: '（他沒有。）' },
            { text: '' },
            { text: '（他只是站起來。像前面一百九十九次一樣。）' },
            { text: '（沒看你一眼。）' },
            { text: '（繼續訓練。）' },
            { text: '' },
            { text: '（這一刻你明白了一件事 —）' },
